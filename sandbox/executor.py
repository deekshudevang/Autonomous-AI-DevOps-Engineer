...
class SandboxExecutor:
    ...
    def spin_up_namespace(self) -> str:
        ...
        ns_metadata = client.V1ObjectMeta(name=ns_name, labels={"purpose": "aship-sandbox"})
    ...
    def execute_tool(self, tool_name: str, args: dict, namespace: str) -> bool:
        ...
        logger.info(f"[Sandbox] Executing {tool_name} with args {args} in {namespace}...")
        ...
        try:
            if tool_name == "kubectl_restart_pod":
                ...
                self.apps_v1.patch_namespaced_deployment(name=deploy_name, namespace=namespace, body=body)
                return True
