...
def parse_and_alert(filepath, fault_lines):
    ...
    try:
        ...
        if res.status_code == 200:
            print(f"[Live Agent] ✅ Alert Successfully Routed. Incident ID: {res.json().get('incident_id')}")
        else:
                ...
                with open(filepath, 'r') as f:
                    ...
                    if new_lines:
                        ...
                        for line in new_lines:
                            ...
                            elif is_faulting and (line.startswith(" ") or line.startswith("\t") or "Error" in line): 
